...
class ImageTranslationLightningModule(pl.LightningModule):
    """
    PyTorch LightningModule for image translation training.
    ...
    def training_step(self, batch: Dict[str, Any], batch_idx: int) -> torch.Tensor:
        ...
        Notes
        -----
        - Targets are used as provided to preserve image shapes (e.g., [B, C, H, W]).
        - The loss combination depends on dict iteration order; ensure loss dict
          insertion order is consistent if that matters.
